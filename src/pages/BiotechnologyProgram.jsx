...
import {
    ...
    FlaskConical, Dna, Activity, Search, Database,
    Award, ShieldCheck, Microscope, Zap, Users
} from 'lucide-react';

const BiotechnologyProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1579154204601-01588f351e67?auto=format&fit=crop&w=2070&q=80"
                alt="Industrial Biotechnology"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Industrial <br className="hidden lg:block" /> Biotechnology
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Innovate for a sustainable future. Master fermentation technology,
                    bio-process engineering, bioinformatics, and genetic engineering for industrial applications.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 25 Jun</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Bridge the gap between biology and industrial manufacturing.
            This program covers the design of bioreactors, downstream processing,
            enzyme technology, and data analysis in life sciences using modern computational tools.
        </p>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Biotechnology', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. R&D Salary', value: '₹5-12 LPA', icon: FlaskConical },
            { label: 'Industry Growth', value: 'Exponential', icon: Activity },
            { label: 'Research Impact', value: 'High', icon: Microscope },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Python (Bio)', 'R Programming', 'BLAST', 'AutoCAD (P&ID)', 'MATLAB',
                'SuperPro Designer', 'PyMOL', 'SnapGene', 'Excel', 'Benchling'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Enzyme Kinetics Analysis', type: 'Mini Project', desc: 'Simulate and analyze enzyme reaction rates using Python/R to determine Km and Vmax.', icon: FlaskConical },
                { title: 'Bioreactor Design & Scale-up', type: 'Major Project', desc: 'Design a stirred-tank bioreactor for large-scale production of a therapeutic protein.', icon: Database },
                { title: 'Genome Sequence Analysis', type: 'Capstone Project', desc: 'Perform a complete variant calling pipeline on NGS data to identify disease-causing mutations.', icon: Dna },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Enzyme Technology & Immobilization",
        "Fermentation Technology (Upstream Processing)",
        "Bioreactor Design & Control Systems",
        "Downstream Processing & Product Recovery",
        "Bioinformatics: Sequence Analysis & Databases",
        "Data Analytics for Biology (Python/R)",
        "Regulatory Affairs & Bioethics",
        "Future Trends: Synthetic Biology & Metabolic Engineering"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹14,999" features={['1-on-1 Mentorship', 'Lab Demonstrations', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Biocon', 'Serum Institute', 'Dr. Reddys', 'Syngene', 'Novozymes', 'Thermo Fisher'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Ready to Innovate with Life Sciences?
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Industrial Biotechnology program and lead the bio-revolution.
            </p>

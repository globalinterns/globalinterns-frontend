...
import {
    ...
    Brain, Cpu, Database, Cloud, Award, TrendingUp, Users,
    BookOpen, Shield, Layers, Code, HardDrive, Briefcase, Zap
} from 'lucide-react';

const MicrosoftAzureAIFundamentalsProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the basics of Artificial Intelligence on Microsoft Azure. Learn about Machine Learning, Computer Vision, NLP, and conversational AI.
                </p>
...
const DiscoverSection = () => (
    <section>
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Azure AI Fundamentals?</h2>
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Start your AI journey with Microsoft's official curriculum. This program is designed to give you a strong foundation in AI concepts and their implementation on Azure.
        </p>

        <div className="grid gap-6">
            {[
                { title: 'Official Microsoft Curriculum', desc: 'Learn using the official AI-900 course material designed by Microsoft.', icon: BookOpen },
                { title: 'Industry Recognition', desc: 'Prepare for the widely recognized Microsoft Azure AI Fundamentals certification.', icon: Award },
                { title: 'Hands-on Labs', desc: 'Practical experience building AI solutions using Azure AI services.', icon: Code },
                { title: 'No Coding Required', desc: 'Perfect for beginners. Focus on concepts and low-code/no-code tools.', icon: Zap },
                { title: 'Expert Mentorship', desc: 'Guidance from Microsoft certified trainers and industry experts.', icon: Users },
                { title: 'Career Boost', desc: 'Add a valuable credential to your resume and open doors to AI roles.', icon: TrendingUp },
            ].map((item, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <p className="text-gray-600 mb-6">Explore the core workloads of Artificial Intelligence and how to implement them on Azure.</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                'Machine Learning', 'Computer Vision', 'Natural Language Processing', 'Conversational AI',
                'Azure AI Services', 'Responsible AI', 'AutoML', 'Azure Bot Service'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <p className="text-gray-600 mb-6">Apply your knowledge with real-world scenarios using Azure's powerful AI tools.</p>
        ...
        <div className="space-y-6">
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Build a Chatbot</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 1 Week</p>
                    <p className="text-gray-500 text-sm">Create a conversational agent using QnA Maker and Azure Bot Service to answer customer queries.</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Custom Vision Project</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 2 Weeks</p>
                    <p className="text-gray-500 text-sm">Train a custom computer vision model to detect and classify objects in images for a retail scenario.</p>
                </div>
            </div>
        </div>
    </section>
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Module 2: Fundamental AI Concepts and Terminology",
        "Module 3: Computer Vision Workloads on Azure",
        "Module 4: Natural Language Processing (NLP) Workloads",
        "Module 5: Conversational AI Workloads",
        "Module 6: Azure Machine Learning & Auto ML",
        "Module 7: Responsible AI and Ethics",
        "Module 8: Generative AI Fundamentals",
        "Module 9: Capstone Project Implementation",
        "Module 10: Certification Exam Preparation (AI-900)"
    ];

    return (
        <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Curriculum</h2>
            <p className="text-gray-600 mb-8">A structured learning path covering all exam objectives for AI-900.</p>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-blue-700">Access to Microsoft Learn documentation and practice tests.</p>
                </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1 space-y-6">
                ...
                <p className="text-gray-400 text-lg">
                    Validate your AI skills with a certificate from Global Interns and prepare for the Microsoft AI-900 exam.
                </p>
            ...
            <div className="flex-1 w-full max-w-md">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#003366] to-gray-900 rounded-xl border border-gray-700 shadow-2xl flex items-center justify-center relative">
                    <div className="text-center p-8">
                        ...
                        <h4 className="font-bold text-xl mb-1">Azure AI Fundamentals</h4>
...
const PricingSection = () => (
    <section>
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Get certified by Microsoft and kickstart your career in Artificial Intelligence.
        </p>
        ...
        <div className="max-w-md mx-auto">
            <div className="rounded-xl p-8 border border-accent-orange shadow-xl ring-1 ring-accent-orange bg-white relative">
                ...
                <div className="mb-8 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Microsoft AI Professional</h3>
                    <p className="text-sm text-gray-500 mb-4">Complete Training & Project Experience</p>
                ...
                <ul className="space-y-4 mb-8">
                    {[
                        'Live Instructor-led Classes', 'Microsoft Official Curriculum', 'Capstone Projects',
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <p className="text-gray-500 text-sm mb-8">Join a network of professionals working at top tech companies.</p>
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-60">
            {['Microsoft', 'Accenture', 'TCS', 'Infosys', 'Wipro', 'Capgemini'].map((company, idx) => (
...
const TestimonialsSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            {[
                { name: 'Aditi Verma', role: 'AI Intern', review: "The Azure AI course was fantastic. I learned how to build chatbots and use computer vision without needing deep coding knowledge initially." },
                { name: 'Rahul Singh', role: 'Data Analyst', review: "Getting the Azure AI Fundamentals certification really boosted my resume. The live classes were very interactive." },
            ].map((item, idx) => (
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Microsoft Azure AI Fundamentals',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Microsoft Azure AI Fundamentals', reason: '' });
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Microsoft Azure AI Fundamentals program and gain the skills to innovate and lead.
            </p>
...
export default MicrosoftAzureAIFundamentalsProgram;

...
import {
    ...
    Megaphone, Target, TrendingUp, Users, ShoppingCart,
    Award, BarChart2, Briefcase, Globe, MessageSquare
} from 'lucide-react';

const SalesMarketingProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Sales & <br className="hidden lg:block" /> Marketing Strategy
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Drive revenue and build brands. Master the art of persuasion,
                    digital marketing funnels, customer relationship management (CRM), and strategic selling.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 1 Jun</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This dynamic program equips you with the skills to excel in the fast-paced world of sales and marketing.
            You'll learn to craft compelling value propositions, manage sales pipelines using CRMs,
            and execute multi-channel marketing campaigns that convert.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Sales & Marketing',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Sales & Marketing', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Comparison', value: '₹5-10 LPA', icon: Briefcase },
            { label: 'Job Demand', value: 'Very High', icon: TrendingUp },
            { label: 'Key Skill', value: 'Comm. & Analytics', icon: Users },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Salesforce', 'HubSpot', 'Google Ads', 'LinkedIn Sales Nav.', 'Mailchimp',
                'Google Analytics', 'Canva', 'Slack', 'ZoomInfo', 'Excel'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Go-to-Market Strategy', type: 'Mini Project', desc: 'Develop a launch plan for a new SaaS product, identifying target segments and channels.', icon: Globe },
                { title: 'Sales Funnel Optimization', type: 'Major Project', desc: 'Analyze a sales process and implement a lead scoring model in HubSpot to improve conversion.', icon: Target },
                { title: 'Integrated Marketing Campaign', type: 'Capstone Project', desc: 'Design a 360-degree marketing campaign for a consumer brand, including social, email, and paid ads.', icon: Megaphone },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "The Sales Process: Prospecting to Closing",
        "CRM Tools & Sales Tech Stack (Salesforce/HubSpot)",
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹14,999" features={['1-on-1 Mentorship', 'Live Roleplays', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Unilever', 'P&G', 'Google Ads', 'Salesforce', 'HubSpot', 'Flipkart'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Sales & Marketing program and master the strategies that drive business growth.
            </p>
...
export default SalesMarketingProgram;

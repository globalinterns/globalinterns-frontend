...
import {
    ...
    Coffee, Server, Cpu, Layers, Box, Terminal,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Java Programming & <br className="hidden lg:block" /> Backend Development
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the world's most popular enterprise language. Learn Core Java, Advanced Java,
                    Spring Boot, and Hibernate to build robust, scalable backend systems.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 25 Feb</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This comprehensive course takes you from "Hello World" to deploying microservices.
            Understand Object-Oriented Programming (OOP), Data Structures, and algorithms before
            diving into enterprise frameworks like Spring Boot to build RESTful APIs.
        </p>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Java', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹4-9 LPA', icon: Briefcase },
            { label: 'Devices Running Java', value: '3 Billion+', icon: Cpu },
            { label: 'Enterprise Adoption', value: '95% of Fortune 500', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Java 17', 'Spring Boot', 'Hibernate', 'Maven', 'MySQL',
                'IntelliJ IDEA', 'Docker', 'JUnit', 'Postman', 'Git'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Library Management System', type: 'Mini Project', desc: 'A console-based application to manage books and members using Core Java concepts.', icon: Terminal },
                { title: 'Employee CRUD API', type: 'Major Project', desc: 'A RESTful API using Spring Boot and Hibernate to manage employee records with database persistence.', icon: Server },
                { title: 'E-commerce Microservices', type: 'Capstone Project', desc: 'A scalable backend for an online store with product catalog, cart, and order services using Microservices architecture.', icon: Layers },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        "Java Fundamentals (Variables, Loops, Logic)",
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Oracle', 'IBM', 'Infosys', 'Wipro', 'TCS', 'Capgemini'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Java program and become a sought-after backend developer.
            </p>

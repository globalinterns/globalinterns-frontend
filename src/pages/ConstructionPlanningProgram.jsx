...
import {
    ...
    Building, Map, Ruler, HardHat, TrendingUp, Users, Award,
    Briefcase, Layout, Hammer
} from 'lucide-react';

const ConstructionPlanningProgram = () => {
    return (
            ...
            >
                ...
                <div className="flex flex-wrap items-center gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-2 text-sm text-white/70">
                        ...
                        <span>Rated 4.7 by learners</span>
                    </div>
                </div>

                {/* Heading */}
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Construction Planning & <br className="hidden lg:block" /> Project Management
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the art of building the future. Learn to plan, execute, and manage
                    large-scale infrastructure projects using modern scheduling tools and management methodologies.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 15 Apr</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This program is tailored for aspiring project managers and civil engineers.
            You will gain expertise in project scheduling, cost estimation, risk management,
            and learn to use industry-standard software like Primavera P6 and Microsoft Project.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Construction Planning',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Construction Planning', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹4-8 LPA', icon: Briefcase },
            { label: 'Construction Industry', value: 'High Growth', icon: Building },
            { label: 'Job Roles', value: 'Project Manager', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Primavera P6', 'MS Project', 'AutoCAD', 'Revit BIM', 'Excel',
                'Navisworks', 'Bluebeam', 'Procore', 'STAAD Pro', 'SAP2000'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Residential Building Schedule', type: 'Mini Project', desc: 'Create a detailed construction schedule for a G+5 apartment complex using MS Project.', icon: Building },
                { title: 'Highway Contruction Plan', type: 'Major Project', desc: 'Develop a comprehensive project management plan including resource allocation for a 50km highway.', icon: Map },
                { title: 'High-Rise Project Management', type: 'Capstone Project', desc: 'A full-scale project simulation for a skyscraper using Primavera P6, including risk & cost analysis.', icon: TrendingUp },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Project Planning & Scheduling (Gantt Charts, CPM)",
        "Resource Management & Allocation",
        "Cost Estimation, Budgeting & Control",
        "Contracts, Tendering & Procurement",
        "Quality Control & Safety Management (HSE)",
        "Hands-on with Microsoft Project (MSP)",
        "Advanced Scheduling with Primavera P6",
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Mentor Led" price="₹9,499" features={['Everything in Self Paced', 'Live Doubt Sessions', 'Internship Certificate', 'Project Review', '1 Year Access', 'Career Support']} recommended />
            <PricingCard title="Professional" price="₹15,499" features={['1-on-1 Mentorship', 'Site Visit Opportunities', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['L&T', 'DLF', 'Tata Projects', 'Sobha', 'GMR', 'Godrej Properties'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Construction Planning program and become a leader in the infrastructure sector.
            </p>
...
export default ConstructionPlanningProgram;

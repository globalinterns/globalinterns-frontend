...
import {
    ...
    Zap, Settings, Gauge, Activity, TrendingUp, Users, Award,
    Briefcase, Thermometer, PenTool
} from 'lucide-react';

const ICEngineDesignProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1574672688463-2283a042e128?auto=format&fit=crop&w=2070&q=80"
                alt="IC Engine Design"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    IC Engine Design & <br className="hidden lg:block" /> Analysis
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Power the world. Master the thermodynamics, design, and computational analysis
                    of Internal Combustion Engines to improve efficiency and performance.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 25 Apr</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Dive deep into the heart of the automobile. This program focuses on the design
            and simulation of 2-stroke and 4-stroke engines using advanced CAD and CFD tools.
            Understand thermal cycles, combustion processes, and emission control technologies.
        </p>

        <div className="grid sm:grid-cols-2 gap-4">
            {[
                'Engine Thermodynamics & Cycles',
                'Design of Components (Piston, Rods)',
                'Combustion Analysis & Emission Control',
                'Turbocharging & Supercharging',
                'CAD Modeling with SolidWorks',
                'CFD Simulation with ANSYS'
            ].map((item, idx) => (
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'IC Engine Design',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'IC Engine Design', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹5-9 LPA', icon: Briefcase },
            { label: 'Vehicles Powered', value: '1.4 Billion+', icon: Gauge },
            { label: 'Innovation Focus', value: 'Hybrid Integration', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'CATIA', 'SolidWorks', 'ANSYS Fluent', 'HyperMesh', 'MATLAB',
                'AutoCAD', 'GT-Power', 'Ricardo WAVE', 'Python', 'Excel'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">What You Will Build</h2>
        <div className="space-y-6">
            {[
                { title: 'Piston Head Stress Analysis', type: 'Mini Project', desc: 'Perform thermal structural analysis on a piston head using ANSYS to identify weak points.', icon: Activity },
                { title: 'Exhaust System Flow Simulation', type: 'Major Project', desc: 'Design an exhaust manifold and simulate gas flow to optimize backpressure and efficiency.', icon: Gauge },
                { title: 'Multi-Cylinder Engine Assembly', type: 'Capstone Project', desc: 'Design and assemble a complete 4-cylinder engine in CAD and perform kinetic analysis.', icon: Settings },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        "Thermodynamics of IC Engines (Otto, Diesel, Dual Cycles)",
        "Construction & Working of 2-Stroke & 4-Stroke Engines",
        "Fuel Injection Systems (MPFI, GDI, CRDI)",
        "Design of Cylinder Block, Head, and Piston",
        "Kinematics of Crankshaft & Connecting Rod (Balancing)",
        "Intake & Exhaust System Design",
        "Turbocharging, Supercharging & Scavenging",
        "3D Modeling of Engine Components (SolidWorks/CATIA)",
        "CFD Analysis of Combustion & Flow (ANSYS)",
        "Emission Norms & Future Technologies"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Mentor Led" price="₹9,999" features={['Everything in Self Paced', 'Live Doubt Sessions', 'Internship Certificate', 'Project Review', '1 Year Access', 'Career Support']} recommended />
            <PricingCard title="Professional" price="₹16,999" features={['1-on-1 Mentorship', 'Job Guarantee Prog.', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Ford', 'General Motors', 'Toyota', 'Honda', 'Cummins', 'BMW'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Ready to Engineer High-Performance Engines?
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our IC Engine Design program and become an expert in automotive power.
            </p>
...
export default ICEngineDesignProgram;

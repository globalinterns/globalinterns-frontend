        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    A structured, industry-aligned program to help you design, build,
                    and deploy modern web applications — with real projects, mentorship,
                    and career guidance.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 5 Feb</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This intensive program bridges the gap between theoretical knowledge and practical application.
            You will learn to build modern, responsive, and secure web applications using the MERN stack.
            Our curriculum is constantly updated to reflect the latest industry standards.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Full Stack Web Development',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Full Stack Web Development', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Active Job Openings', value: '120,000+', icon: Users },
            { label: 'YoY Market Growth', value: '22%', icon: TrendingUp },
        ].map((stat, idx) => (
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                ...
                'Express', 'MongoDB', 'Git', 'GitHub', 'VS Code'
            ].map((tool, idx) => (
                <div key={idx} className="bg-white border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-3 hover:border-gray-300 transition-colors aspect-square">
                    {/* Placeholder for Logos - specific SVGs would be better for premium look */}
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Personal Portfolio', type: 'Mini Project', desc: 'A responsive personal portfolio website showcasing your skills and resume.', icon: Layout },
                { title: 'E-commerce Dashboard', type: 'Major Project', desc: 'A full-featured admin dashboard with charts, data tables, and user management.', icon: Database },
                { title: 'Full Stack Social App', type: 'Capstone Project', desc: 'A complete social media application with authentication, posts, and realtime updates.', icon: Globe },
            ].map((project, idx) => (

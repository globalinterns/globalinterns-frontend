...
import {
    ...
    Users, Briefcase, UserCheck, HeartHandshake, TrendingUp, Award,
    FileText, MessageCircle, BarChart
} from 'lucide-react';

const HumanResourcesProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1551836022-d5d88e9218df?auto=format&fit=crop&w=2070&q=80"
                alt="Human Resources"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Human Resource <br className="hidden lg:block" /> Management (HR)
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    People are the greatest asset of any organization. Learn to recruit top talent,
                    manage employee relations, and build thriving workplace cultures.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 5 May</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Become a strategic HR leader. This program covers the full employee lifecycle,
            from recruitment and onboarding to performance management and labor laws.
            Gain practical skills in HR analytics and digital HR tools.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Human Resources',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Human Resources', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Role Demand', value: 'High Growth', icon: Users },
            { label: 'Key Skill', value: 'Emotional Intel.', icon: HeartHandshake },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Excel', 'Power BI', 'LinkedIn Recruiter', 'Workday', 'BambooHR',
                'Naukri Portal', 'Zoho People', 'Tableau', 'Canva', 'Slack'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Recruitment Drive Plan', type: 'Mini Project', desc: 'Design an end-to-end recruitment strategy for a tech startup hiring 50 engineers.', icon: UserCheck },
                { title: 'Employee Handbook Design', type: 'Major Project', desc: 'Create a comprehensive policy manual covering code of conduct, leave, and benefits.', icon: FileText },
                { title: 'HR Analytics Dashboard', type: 'Capstone Project', desc: 'Build a dynamic dashboard using Power BI to visualize attrition rates and performance metrics.', icon: BarChart },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Employee Relations & Labor Laws (India)",
        "Organizational Behavior & Culture",
        "HR Analytics & Metrics (Data-Driven HR)",
        "HR Information Systems (HRIS) & Tools",
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹14,999" features={['1-on-1 Mentorship', 'Resume Building', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Deloitte', 'KPMG', 'Accenture', 'TCS', 'Amazon HR', 'Google People Ops'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Ready to Shape Organizational Culture?
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Human Resources program and build the skills to manage talent effectively.
            </p>
...
export default HumanResourcesProgram;

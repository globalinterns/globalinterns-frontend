...
import {
    ...
    Code, Database, Layout, Server, Github, Globe,
    Briefcase, Award, TrendingUp, Users, Smartphone,
    Wifi, Layers, Box
} from 'lucide-react';

const AndroidDevelopmentProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Android App <br className="hidden lg:block" /> Development
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Build next-gen mobile applications for billions of users. Master Kotlin,
                    Jetpack Compose, and Android Studio to create stunning, high-performance apps.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 15 Feb</span>
                    </div>

                    <div className="flex items-center gap-3">
                        <Clock className="w-5 h-5 text-accent-orange" />
                        <span>Duration: 9 weeks</span>
                    </div>
                </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Dive into the world of mobile app development with Google's preferred language, Kotlin.
            This program covers everything from UI design with XML and Jetpack Compose to backend integration
            with Firebase and APIs, equipping you to publish your own apps to the Play Store.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Android Development',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Android Development', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Active App Users', value: '3.5 Billion', icon: Smartphone },
            { label: 'Jobs in Mobility', value: '1M+ by 2026', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Android Studio', 'Kotlin', 'Java', 'XML', 'Jetpack Compose',
                'Firebase', 'Room DB', 'Retrofit', 'Git', 'Gradle'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Note Taking App', type: 'Mini Project', desc: 'A productive offline app using Room Database to create, edit, and delete notes.', icon: Layout },
                { title: 'Weather Forecast App', type: 'Major Project', desc: 'Real-time weather application fetching data from OpenWeatherMap API with location services.', icon: Wifi },
                { title: 'Food Delivery Native App', type: 'Capstone Project', desc: 'Complete e-commerce solution with cart, payment gateway, and Google Maps integration.', icon: Smartphone },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        "Android Fundamentals & Studio Setup",
        "Kotlin Programming Basics to Advanced",
        "Building UI with XML & Views",
        "Modern UI with Jetpack Compose",
        "Activity & Fragment Lifecycle",
        "Networking with Retrofit & APIs",
        "Local Database with Room",
        "Firebase Auth & Cloud Firestore",
        "Background Services & Notifications",
        "App Publishing to Google Play Console"
    ];
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Google', 'Uber', 'Zomato', 'Swiggy', 'Paytm', 'PhonePe'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Android Development program and start building apps that reach millions of users.
            </p>
...
export default AndroidDevelopmentProgram;

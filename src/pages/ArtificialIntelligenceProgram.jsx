...
import {
    ...
    Brain, Cpu, Database, Server, Code, Bot,
    Briefcase, Award, TrendingUp, Users, ArrowRight
} from 'lucide-react';

const ArtificialIntelligenceProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&w=2072&q=80"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the future of technology by learning Machine Learning, Deep Learning,
                    and Neural Networks. Build intelligent systems that solve real-world problems.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 10 Feb</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This comprehensive program is designed to take you from the basics of Python programming to advanced Deep Learning concepts.
            You will work with real datasets, train machine learning models, and deploy AI applications.
            Whether you're a beginner or looking to upskill, this course provides the foundation for a high-growth career in AI.
        </p>
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹6-12 LPA', icon: Briefcase },
            { label: 'Projected Job Growth', value: '35%', icon: Users },
            { label: 'Global Market Size', value: '$196B+', icon: TrendingUp },
        ].map((stat, idx) => (
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                ...
                'NumPy', 'Jupyter', 'OpenCV', 'Keras', 'Matplotlib'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'House Price Predictor', type: 'Mini Project', desc: 'A regression model to predict housing prices based on various features like area, location, and amenities.', icon: Code },
                { title: 'Face Mask Detection', type: 'Major Project', desc: 'A Computer Vision application using OpenCV and Deep Learning to detect face masks in real-time video.', icon: Brain },
                { title: 'Intelligent Chatbot', type: 'Capstone Project', desc: 'An NLP-based chatbot capable of understanding context and answering user queries effectively.', icon: Bot },
            ].map((project, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our AI program and build the skills needed for the next generation of technology.
            </p>
...
export default ArtificialIntelligenceProgram;

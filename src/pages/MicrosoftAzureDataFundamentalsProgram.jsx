...
import {
    ...
    Database, BarChart, Server, Globe, Award, TrendingUp, Users,
    BookOpen, Shield, Layers, Code, HardDrive, Briefcase, Zap, PieChart
} from 'lucide-react';

const MicrosoftAzureDataFundamentalsProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the basics of data concepts on Microsoft Azure. Learn about relational and non-relational data, and analytics workloads.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    ...
                    {/* Assuming Live based on user request for other MS programs, though not explicitly stated for this one in the prompt, it aligns with the others. */}
                    <div className="flex items-center gap-3">
...
const DiscoverSection = () => (
    <section>
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Azure Data Fundamentals?</h2>
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Data is the new oil. Start your data career with Microsoft's official curriculum. Understand how to manage, process, and analyze data in the cloud.
        </p>

        <div className="grid gap-6">
            {[
                { title: 'Official Microsoft Curriculum', desc: 'Learn using the official DP-900 course material designed by Microsoft.', icon: BookOpen },
                { title: 'Industry Recognition', desc: 'Prepare for the globally recognized Microsoft Azure Data Fundamentals certification.', icon: Award },
                { title: 'Data Workloads', desc: 'Understand transactional, analytical, and streaming data workloads.', icon: BarChart },
                { title: 'Azure SQL & Cosmos DB', desc: 'Hands-on exposure to powerful database services on Azure.', icon: Database },
                { title: 'Modern Data Warehousing', desc: 'Introduction to Azure Synapse Analytics and data processing.', icon: Server },
                { title: 'Launch Your Career', desc: 'The first step towards becoming a Data Engineer, Data Analyst, or DBA.', icon: TrendingUp },
            ].map((item, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <p className="text-gray-600 mb-6">Explore the tools and services that power modern data solutions on Azure.</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                'Azure SQL Database', 'Azure Cosmos DB', 'Azure Storage', 'Azure Synapse',
                'Power BI', 'Azure Data Factory', 'Relational Data', 'NoSQL'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <p className="text-gray-600 mb-6">Solidify your understanding with practical tasks involving real data services.</p>
        ...
        <div className="space-y-6">
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Provision a SQL Database</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 1 Week</p>
                    <p className="text-gray-500 text-sm">Create and configure an Azure SQL Database, import data, and run basic queries.</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Visualize Data with Power BI</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 1 Week</p>
                    <p className="text-gray-500 text-sm">Connect Power BI Desktop to your Azure data source and create a simple interactive dashboard.</p>
                </div>
            </div>
        </div>
    </section>
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Module 2: Roles and Tasks in Data",
        "Module 3: Relational Data on Azure",
        "Module 4: Non-Relational Data on Azure",
        "Module 5: Modern Data Warehousng Analytics",
        "Module 6: Azure Synapse Analytics Fundamentals",
        "Module 7: Azure Data Factory Fundamentals",
        "Module 8: Data Visualization with Power BI",
        "Module 9: Data Security & Governance",
        "Module 10: Certification Exam Preparation (DP-900)"
    ];

    return (
        <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Curriculum</h2>
            <p className="text-gray-600 mb-8">A focused curriculum covering all key topics for the DP-900 exam.</p>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-blue-700">Access to Azure samples and Microsoft Learn data paths.</p>
                </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1 space-y-6">
                ...
                <p className="text-gray-400 text-lg">
                    Validate your data proficiency with a certificate from Global Interns and prepare for the Microsoft DP-900 exam.
                </p>
            ...
            <div className="flex-1 w-full max-w-md">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#003366] to-gray-900 rounded-xl border border-gray-700 shadow-2xl flex items-center justify-center relative">
                    <div className="text-center p-8">
                        ...
                        <h4 className="font-bold text-xl mb-1">Azure Data Fundamentals</h4>
...
const PricingSection = () => (
    <section>
        ...
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Get certified by Microsoft and kickstart your career in Data Engineering or Analytics.
        </p>
        ...
        <div className="max-w-md mx-auto">
            <div className="rounded-xl p-8 border border-accent-orange shadow-xl ring-1 ring-accent-orange bg-white relative">
                ...
                <div className="mb-8 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Microsoft Data Professional</h3>
                    <p className="text-sm text-gray-500 mb-4">Complete Training & Hands-on Labs</p>
                ...
                <ul className="space-y-4 mb-8">
                    {[
                        'Live Instructor-led Classes', 'Microsoft Official Curriculum', 'Azure Data Labs',
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <p className="text-gray-500 text-sm mb-8">Join a network of professionals working at leading data-driven companies.</p>
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-60">
            {['Microsoft', 'IBM', 'Capgemini', 'TCS', 'Infosys', 'Accenture'].map((company, idx) => (
...
const TestimonialsSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            {[
                { name: 'Amit Desai', role: 'Junior Data Engineer', review: "DP-900 was my entry into the world of Big Data. The course made complex topics like Synapse and Cosmos DB easy to understand." },
                { name: 'Sara Khan', role: 'Data Analyst', review: "I use Power BI daily now. This course gave me the confidence to work with data in the cloud. Highly recommended!" },
            ].map((item, idx) => (
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Microsoft Azure Data Fundamentals',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Microsoft Azure Data Fundamentals', reason: '' });
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Unlock the Power of Azure Data
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Microsoft Azure Data Fundamentals program and become a data expert.
            </p>
...
export default MicrosoftAzureDataFundamentalsProgram;

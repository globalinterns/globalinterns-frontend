...
import {
    ...
    Brain, Database, Server, Code, Bot, LineChart, Network,
    Briefcase, Award, TrendingUp, Users, ArrowRight
} from 'lucide-react';

const MachineLearningProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Unlock the power of data. Learn to build predictive models, master algorithms,
                    and create intelligent systems that learn from experience.
                </p>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This specialized program dives deep into Machine Learning algorithms and their practical applications.
            You will master data preprocessing, model selection, tuning, and deployment.
            We focus on hands-on coding with Python libraries to solve complex data problems.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Machine Learning',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Machine Learning', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Demand Increase', value: '40% YoY', icon: Users },
            { label: 'Market Value', value: '$117B', icon: TrendingUp },
        ].map((stat, idx) => (
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                ...
                'Seaborn', 'Jupyter', 'Flask', 'XGBoost', 'LightGBM'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Credit Card Fraud Detection', type: 'Mini Project', desc: 'Build a classification model to detect fraudulent transactions using logistic regression and decision trees.', icon: Code },
                { title: 'Movie Recommendation Engine', type: 'Major Project', desc: 'Create a collaborative filtering system to recommend movies to users based on their viewing history.', icon: Brain },
                { title: 'Stock Price Prediction App', type: 'Capstone Project', desc: 'Develop a time-series forecasting application using LSTM/ARIMA and deploy it as a web app.', icon: LineChart },
            ].map((project, idx) => (
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            <PricingCard title="Self Paced" price="₹4,499" features={['Recorded Lectures', 'Assignments', 'Course Certificate', '6 Months Access']} />
            ...
            <PricingCard title="Professional" price="₹15,999" features={['1-on-1 Mentorship', 'Job Guarantee Prog.', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our ML program and build the skills needed for the data-driven future.
            </p>

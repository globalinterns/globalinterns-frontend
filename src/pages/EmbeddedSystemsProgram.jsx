...
import {
    ...
    Cpu, Zap, Radio, Settings, Wifi, Server,
    Briefcase, Award, TrendingUp, Users, CircuitBoard
} from 'lucide-react';

const EmbeddedSystemsProgram = () => {
    return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Embedded Systems & <br className="hidden lg:block" /> IoT Design
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Bridge the gap between hardware and software. Master Microcontrollers,
                    RTOS, and Firmware Development to build smart, connected devices.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 10 Mar</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This program dives deep into the architecture of microcontrollers and processors.
            You will learn to write efficient firmware using Embedded C/C++, interface sensors and actuators,
            and design real-time systems that power automotive, medical, and industrial applications.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Embedded Systems',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Embedded Systems', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹4.5-9 LPA', icon: Briefcase },
            { label: 'IoT Devices by 2030', value: '29 Billion', icon: Wifi },
            { label: 'Industry Growth', value: 'Automotive & EV', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Hardware & Tools</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Embedded C', 'C++', 'Arduino', 'STM32', 'Raspberry Pi',
                'FreeRTOS', 'I2C/SPI', 'UART', 'KiCad', 'Proteus'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Digital Weather Station', type: 'Mini Project', desc: 'Interface temperature and humidity sensors with an LCD display using Arduino/AVR.', icon: Settings },
                { title: 'Smart Home Automation', type: 'Major Project', desc: 'Control home appliances remotely via Bluetooth/Wi-Fi using IoT protocols.', icon: Wifi },
                { title: 'Autonomous Obstacle Avoidance Robot', type: 'Capstone Project', desc: 'Build a robot using ultrasonic sensors and algorithms to navigate environments independently.', icon: Cpu },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Interfacing: GPIOs, LEDs, Switches",
        "ADC, DAC & Sensor Interfacing",
        "Communication Protocols (UART, I2C, SPI)",
        "ARM Cortex-M Architecture & Programming",
        "Introduction to RTOS (Real-Time Operating Systems)",
        "IoT Basics & Wireless Connectivity (Wi-Fi, BLE)",
        "Final Project Implementation & Optimization"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹18,999" features={['1-on-1 Mentorship', 'Hardware Kit Included', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Qualcomm', 'Intel', 'Bosch', 'Tesla', 'NVIDIA', 'Honeywell'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Ready to Build the Future of Hardware?
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Embedded Systems program and start creating smart technologies that power the world.
            </p>
...
export default EmbeddedSystemsProgram;

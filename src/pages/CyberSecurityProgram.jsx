...
import {
    ...
    Shield, Lock, Globe, Server, Terminal,
    Briefcase, Award, TrendingUp, Users, AlertTriangle,
    Eye, Key
} from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Cyber Security & <br className="hidden lg:block" /> Ethical Hacking
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Become a digital defender. Master the art of penetration testing, network security,
                    and cryptography to protect organizations from evolving cyber threats.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 20 Feb</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            In an era of increasing digital threats, cybersecurity professionals are in high demand.
            This hands-on program trains you in offensive and defensive security techniques. You'll learn
            to identify vulnerabilities, secure networks, and perform ethical hacking simulations.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Cyber Security',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Cyber Security', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Unfilled Jobs', value: '3.5 Million', icon: Users },
            { label: 'YoY Demand', value: '31%', icon: TrendingUp },
        ].map((stat, idx) => (
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                ...
                'Python', 'Linux', 'Snort', 'SQLMap', 'Hashcat'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Network Vulnerability Scanner', type: 'Mini Project', desc: 'A Python-based tool to scan networks for open ports and potential security weaknesses.', icon: Eye },
                { title: 'Keylogger & Malware Analysis', type: 'Major Project', desc: 'Understand malware behavior by building a basic keylogger (for educational purposes only) and analyzing it.', icon: AlertTriangle },
                { title: 'Web App Penetration Test', type: 'Capstone Project', desc: 'Perform a comprehensive security audit on a sample web application and generate a vulnerability report.', icon: Lock },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "System Hacking & Exploitation (Metasploit)",
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Palo Alto', 'Cisco', 'IBM Security', 'FireEye', 'CrowdStrike', 'McAfee'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Cyber Security program to become an ethical hacker and security expert.
            </p>

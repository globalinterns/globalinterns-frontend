...
import {
    ...
    Zap, Battery, BatteryCharging, Gauge, Settings,
    Briefcase, Award, TrendingUp, Users, Truck
} from 'lucide-react';

const HybridVehiclesProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1593941707882-a5bba14938c7?auto=format&fit=crop&w=2072&q=80"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Hybrid Electric <br className="hidden lg:block" /> Vehicle Design
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Drive the future of automotive engineering. Master the design, simulation, and
                    control of Hybrid and Electric Vehicle powertrains, battery management systems, and charging infrastructure.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 20 Mar</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This specialized program empowers engineers to design eco-friendly transportation solutions.
            Delve into EV architecture, battery thermodynamics, motor control strategies, and
            regenerative braking systems using industry-standard simulation tools.
        </p>

        <div className="grid sm:grid-cols-2 gap-4">
            {[
                'EV Powertrain & Architecture',
                'Li-Ion Battery Management (BMS)',
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Hybrid Electric Vehicle',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Hybrid Electric Vehicle', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹5-12 LPA', icon: Briefcase },
            { label: 'EV Market Growth', value: '29% CAGR', icon: TrendingUp },
            { label: 'Green Energy Impact', value: 'Net Zero 2050', icon: Zap },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'MATLAB', 'Simulink', 'ANSYS', 'SolidWorks', 'Python',
                'CAN Protocol', 'AutoCAD', 'LabVIEW', 'Multisim', 'PSpice'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Battery Thermal Model', type: 'Mini Project', desc: 'Simulate the heat generation in a Li-Ion battery pack and design an effective cooling system.', icon: Battery },
                { title: 'Regenerative Braking System', type: 'Major Project', desc: 'Model and analyze a regenerative braking system to recover energy and extend vehicle range.', icon: Gauge },
                { title: 'Complete EV Powertrain Simulation', type: 'Capstone Project', desc: 'Design and simulate an entire EV powertrain system including motor, inverter, and transmission.', icon: Truck },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        "Introduction to EVs & Hybrid Vehicles",
        "Vehicle Dynamics & Propulsion Systems",
        "Electric Motors & Drives (BLDC, PMSM)",
        "Battery Technologies (Li-Ion, BMS Architecture)",
        "Power Electronics (Inverters, DC-DC Converters)",
        "Regenerative Braking & Energy Management",
        "Hybrid Vehicle Architectures (Series, Parallel)",
        "Modelling & Simulation with MATLAB/Simulink",
        "EV Charging Infrastructure & Standards",
        "Future Trends: V2G, Wireless Charging"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Mentor Led" price="₹11,999" features={['Everything in Self Paced', 'Live Doubt Sessions', 'Internship Certificate', 'Project Review', '1 Year Access', 'Career Support']} recommended />
            <PricingCard title="Professional" price="₹19,999" features={['1-on-1 Mentorship', 'Job Guarantee Prog.', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Tesla', 'Tata Motors', 'Ola Electric', 'Mahindra', 'Ather', 'Hyundai'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Hybrid Electric Vehicle program and engineer the sustainable cars of tomorrow.
            </p>
...
export default HybridVehiclesProgram;

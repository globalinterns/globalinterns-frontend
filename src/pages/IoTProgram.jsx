...
import {
    ...
    Wifi, Cloud, Cpu, Smartphone, Globe, Activity,
    Briefcase, Award, TrendingUp, Users, Server
} from 'lucide-react';
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1558346490-a72e53ae2d4f?auto=format&fit=crop&w=2070&q=80"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Internet of Things <br className="hidden lg:block" /> (IoT)
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Connect the physical world to the digital realm. Learn to design smart devices,
                    sensor networks, and cloud-integrated systems that are reshaping industries.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 15 Mar</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This program covers the complete IoT ecosystem: from sensors and microcontrollers to
            communication protocols and cloud platforms. You will learn to build end-to-end IoT
            solutions for smart homes, agriculture, healthcare, and industrial automation.
        </p>

        <div className="grid sm:grid-cols-2 gap-4">
            {[
                'Sensors & Actuators Interfacing',
                'Wireless Protocols (MQTT, CoAP)',
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Internet of Things',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Internet of Things', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹5-10 LPA', icon: Briefcase },
            { label: 'Global Market Size', value: '$1.5 Trillion', icon: Globe },
            { label: 'Growth in Smart Cities', value: 'Rapid', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Raspberry Pi', 'Arduino', 'ESP32', 'Python', 'Node-RED',
                'MQTT', 'AWS IoT', 'Blynk', 'LoRaWAN', 'Zigbee'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Smart Agriculture System', type: 'Mini Project', desc: 'Monitor soil moisture and temperature remotely and automate irrigation.', icon: Activity },
                { title: 'Home Energy Monitor', type: 'Major Project', desc: 'Track energy consumption of appliances in real-time and visualize data on a cloud dashboard.', icon: Wifi },
                { title: 'Industrial Safety Helmet', type: 'Capstone Project', desc: 'A smart helmet for workers that detects hazardous gases, falls, and tracks location.', icon: Cpu },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Microcontrollers for IoT (ESP8266/ESP32)",
        "IoT Communication Protocols (HTTP, MQTT, CoAP)",
        "Wireless Technologies (Wi-Fi, Bluetooth, Zigbee)",
        "Cloud IoT Platforms (AWS IoT Core / ThingSpeak)",
        "IoT Gateway & Edge Computing",
        "Interfacing with Mobile Apps (Blynk/MIT App Inventor)",
        "Data Analytics & Visualization for IoT",
        "Security & Privacy in IoT Systems"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            <PricingCard title="Self Paced" price="₹5,499" features={['Recorded Lectures', 'Assignments', 'Course Certificate', '6 Months Access']} />
            <PricingCard title="Mentor Led" price="₹10,999" features={['Everything in Self Paced', 'Live Doubt Sessions', 'Internship Certificate', 'Project Review', '1 Year Access', 'Career Support']} recommended />
            <PricingCard title="Professional" price="₹17,999" features={['1-on-1 Mentorship', 'Hardware Kit Included', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Samsung', 'Philips', 'Siemens', 'GE Digital', 'Cisco', 'Schneider'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our IoT program and start building smart, connected solutions for a smarter future.
            </p>

...
import {
    ...
    Terminal, Database, Layout, Server, Code,
    Briefcase, Award, TrendingUp, Users, Zap,
    Cpu
} from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Python Programming <br className="hidden lg:block" />
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Learn the most versatile programming language in the world. From automation and
                    scripting to web development and data analysis, Python opens doors to endless possibilities.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 1 Mar</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Immerse yourself in Python, the language powering Google, Instagram, and Spotify.
            This course is designed for beginners and intermediates alike, covering core concepts,
            object-oriented programming, file handling, and real-world applications including
            web scraping and basics of web development with Django/Flask.
        </p>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Python', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Most Loved Language', value: '#1 in 2024', icon: Star },
            { label: 'Job Openings', value: 'High Demand', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Python 3.12', 'VS Code', 'PyCharm', 'Git', 'GitHub',
                'Django', 'Flask', 'Pandas', 'Requests', 'Selenium'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Automated Web Scraper', type: 'Mini Project', desc: 'Build a bot to extract data from e-commerce websites and save it to a CSV file.', icon: Terminal },
                { title: 'Personal Expense Tracker', type: 'Major Project', desc: 'A GUI-based desktop application (Tkinter/PyQt) or web app to manage personal finances.', icon: Layout },
                { title: 'Full Stack Blog Application', type: 'Capstone Project', desc: 'Create a feature-rich blogging platform using Django/Flask with user authentication and database integration.', icon: Server },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Building & Deploying Python Applications"
    ];
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Google', 'Netflix', 'Instagram', 'Spotify', 'Pinterest', 'Dropbox'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Python program and unlock opportunities in web development, data science, and automation.
            </p>

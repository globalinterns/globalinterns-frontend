...
import {
    ...
    Globe, BarChart, Megaphone, Smartphone, Award, TrendingUp, Users,
    BookOpen, Shield, Layers, Code, Briefcase, Zap, Target, Share2
} from 'lucide-react';

const MetaDigitalMarketingAssociateProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            ...
            />
            {/* Premium overlay with Meta Blue tint */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#1877f2]/80 via-slate-900/80 to-slate-950/60" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Launch your career in digital marketing with Meta. Master advertising on Facebook, Instagram, Messenger, and WhatsApp.
                </p>
...
const DiscoverSection = () => (
    <section>
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Meta Digital Marketing?</h2>
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            Meta technologies connect billions of people. Learning how to market effectively on these platforms is a critical skill for the modern digital economy.
        </p>

        <div className="grid gap-6">
            {[
                { title: 'Official Meta Curriculum', desc: 'Study the exact material designed by Meta for the Digital Marketing Associate certification.', icon: BookOpen },
                { title: 'Industry Recognition', desc: 'Earn a globally recognized certification from Meta that employers value.', icon: Award },
                { title: 'Master Meta Ads', desc: 'Gain deep knowledge of Meta Ads Manager, Business Suite, and targeting tools.', icon: Target },
                { title: 'Cross-Platform Skills', desc: 'Learn to run integrated campaigns across Facebook, Instagram, and WhatsApp.', icon: Share2 },
                { title: 'Measurable Results', desc: 'Understand how to read reports, analyze metrics, and optimize campaigns for ROI.', icon: BarChart },
                { title: 'Career Growth', desc: 'Prepare for roles like Digital Marketing Specialist, Social Media Manager, and Media Buyer.', icon: TrendingUp },
            ].map((item, idx) => (
                <div key={idx} className="flex gap-4 p-4 rounded-xl border border-gray-100 bg-white hover:shadow-md transition-shadow">
                    <div className="w-12 h-12 bg-blue-50 text-[#1877f2] rounded-lg flex items-center justify-center flex-shrink-0">
...
const ToolsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Platforms & Tools</h2>
        <p className="text-gray-600 mb-6">Become proficient in the core tools used by professional digital marketers.</p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                'Facebook Core', 'Instagram Business', 'Messenger', 'WhatsApp Business',
                'Meta Ads Manager', 'Business Suite', 'Audience Insights', 'Meta Pixel'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <p className="text-gray-600 mb-6">Apply your skills by designing and launching real-world simulated campaigns.</p>
        ...
        <div className="space-y-6">
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Brand Awareness Campaign</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 1 Week</p>
                    <p className="text-gray-500 text-sm">Design a complete brand awareness ad campaign for Facebook and Instagram, defining audience and creatives.</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    <h3 className="font-bold text-lg text-gray-900">Lead Generation Strategy</h3>
                    <p className="text-gray-600 text-sm mb-2">Duration: 2 Weeks</p>
                    <p className="text-gray-500 text-sm">Create a lead generation campaign using Instant Forms and analyze performance metrics to optimize cost per lead.</p>
                </div>
            </div>
        </div>
    </section>
...
const SyllabusSection = () => {
    const modules = [
        "Module 1: The Value of Meta Technologies",
        "Module 2: Establishing a Platform Presence",
        "Module 3: Fundamentals of Meta Advertising",
        "Module 4: Creating and Managing Ads in Ads Manager",
        "Module 5: Audience Targeting Strategies",
        "Module 6: Ad Formats and Placements",
        "Module 7: Budgeting and Scheduling",
        "Module 8: Performance Analysis & Reporting",
        "Module 9: Optimization Strategies",
        "Module 10: Certification Exam Prep (100-101)"
    ];

    return (
        <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Course Curriculum</h2>
            <p className="text-gray-600 mb-8">Comprehensive coverage of the Meta Certified Digital Marketing Associate exam objectives.</p>
            ...
            <div className="border border-gray-200 rounded-xl divide-y divide-gray-200 overflow-hidden bg-white shadow-sm mb-6">
                {modules.map((module, idx) => (
                    <div key={idx} className="p-4 hover:bg-gray-50 transition-colors flex items-center gap-3">
                        <span className="w-8 h-8 rounded-full bg-blue-50 text-[#1877f2] flex items-center justify-center text-xs font-bold flex-shrink-0">
                            {idx + 1}
                        </span>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-blue-700">Access to Meta Blueprint study guides and practice tests.</p>
                </div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1 space-y-6">
                <div className="inline-flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full text-sm font-medium text-amber-300">
                    ...
                    <span>Official Meta Certification</span>
                </div>
                <h2 className="text-3xl font-bold leading-tight">Become Meta Certified</h2>
                <p className="text-gray-400 text-lg">
                    Validate your digital marketing expertise with a certificate from Global Interns and the official Meta Digital Marketing Associate certification.
                </p>
            ...
            <div className="flex-1 w-full max-w-md">
                <div className="aspect-[4/3] bg-gradient-to-br from-[#1877f2] to-gray-900 rounded-xl border border-gray-700 shadow-2xl flex items-center justify-center relative">
                    <div className="text-center p-8">
                        <Award className="w-16 h-16 text-amber-500 mx-auto mb-4" />
                        <h4 className="font-bold text-xl mb-1">Digital Marketing Associate</h4>
                        <p className="text-gray-500 text-sm">Meta & Global Interns</p>
                    </div>
                </div>
            </div>
        </div>
...
const PricingSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">Invest in Your Career</h2>
        <p className="text-gray-600 text-center max-w-2xl mx-auto mb-12">
            Get certified by one of the biggest names in tech. Start your journey today.
        </p>
        ...
        <div className="max-w-md mx-auto">
            <div className="rounded-xl p-8 border border-accent-orange shadow-xl ring-1 ring-accent-orange bg-white relative">
                ...
                <div className="mb-8 text-center">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Meta Marketing Pro</h3>
                    <p className="text-sm text-gray-500 mb-4">Complete Training & Certification</p>
                ...
                <ul className="space-y-4 mb-8">
                    {[
                        'Live Instructor-led Classes', 'Meta Official Curriculum', 'Hands-on Ads Manager',
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <p className="text-gray-500 text-sm mb-8">Join a network of professionals making an impact at top agencies and brands.</p>
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-60">
            {['Meta', 'Google', 'Ogilvy', 'Dentsu', 'Havas', 'Publicis'].map((company, idx) => (
...
const TestimonialsSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-2 gap-6">
            {[
                { name: 'Ananya Gupta', role: 'Social Media Manager', review: "The Meta certification gave me so much credibility. I learned how to properly structure campaigns and measure ROI." },
                { name: 'Vikram Singh', role: 'Digital Marketing Executive', review: "A comprehensive course. The hands-on practice with Ads Manager was exactly what I needed to land my first job." },
            ].map((item, idx) => (
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Meta Digital Marketing Associate',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Meta Digital Marketing Associate', reason: '' });
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Meta Digital Marketing Associate program and validate your skills with a globally recognized certification.
            </p>
...
export default MetaDigitalMarketingAssociateProgram;

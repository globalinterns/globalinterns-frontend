...
import {
    ...
    Brain, Heart, Activity, Ear, Users,
    Award, MessageCircle, FileText, Smile, UserPlus
} from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Applied <br className="hidden lg:block" /> Psychology
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Unlock the human mind. Master the fundamentals of clinical psychology,
                    counseling techniques, organizational behavior, and mental health first aid.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 1 July</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This program offers a deep dive into the practical applications of psychology.
            From understanding cognitive processes to practicing active listening and empathy,
            you will gain the skills needed for careers in counseling, HR, and mental wellness.
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
            {[
                ...
                'Organizational Behavior (IO Psychology)',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Psychology', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Counselor Salary', value: '₹4-8 LPA', icon: Heart },
            { label: 'Mental Health Demand', value: 'Rising Fast', icon: Activity },
            { label: 'Career Paths', value: 'Diverse', icon: Users },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Methods & Tools</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'DSM-5', 'CBT Techniques', 'SPSS (Research)', 'Mindfulness', 'Psychometric Tests',
                'Excel', 'Zoom (Telehealth)', 'Canva (Psychoed)', 'Qualtrics', 'Mental Status Exam'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Case Study Analysis', type: 'Mini Project', desc: 'supervise a hypothetical clinical case, formulate a diagnosis based on symptoms, and suggest a treatment plan.', icon: FileText },
                { title: 'Wellness Workshop', type: 'Major Project', desc: 'Design a mental health awareness workshop for corporate employees or students.', icon: Users },
                { title: 'Research Proposal', type: 'Capstone Project', desc: 'Develop a research proposal on a contemporary psychological issue (e.g., social media impact).', icon: Brain },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Developmental Psychology: Lifespan Approach",
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹12,999" features={['1-on-1 Mentorship', 'Case Discussions', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['YourDOST', 'Wysa', 'BetterLYF', 'Fortis Healthcare', 'VIMHANS'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Psychology program and start your journey towards understanding the human mind.
            </p>
...
export default PsychologyProgram;

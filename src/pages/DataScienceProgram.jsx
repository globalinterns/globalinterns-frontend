        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Data Science And <br className="hidden lg:block" /> Analytics
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the art of extracting insights from data. Learn Python, SQL, Machine Learning,
                    and Visualization techniques to drive business decisions.
                </p>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This comprehensive program takes you from the basics of Python programming to advanced
            Machine Learning algorithms. You will work on real-world datasets to solve complex business problems,
            making you job-ready for the high-demand field of Data Science.
        </p>
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            ...
            { label: 'Data Scientist Jobs', value: '96,000+', icon: Users },
            { label: 'Market Growth (CAGR)', value: '28%', icon: TrendingUp },
        ].map((stat, idx) => (
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                ...
                'Scikit-learn', 'SQL', 'Tableau', 'Power BI', 'Jupyter'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Sales Forecasting Dashboard', type: 'Mini Project', desc: 'Predict future sales trends using time-series analysis and visualize data interactively.', icon: BarChart2 },
                { title: 'Customer Churn Prediction', type: 'Major Project', desc: 'Build a classification model to identify customers likely to leave and suggest retention strategies.', icon: PieChart },
                { title: 'Recommendation Engine', type: 'Capstone Project', desc: 'Create a Movie Recommendation System using collaborative filtering and content-based filtering.', icon: Activity },
            ].map((project, idx) => (
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Google', 'Microsoft', 'Amazon', 'Accenture', 'IBM', 'Deloitte'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our comprehensive program and launch your career in one of the most exciting fields of this decade.
            </p>

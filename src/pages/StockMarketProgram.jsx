...
import {
    ...
    TrendingUp, Activity, DollarSign, BarChart2, PieChart,
    Award, Zap, LineChart, Briefcase, Monitor, Users
} from 'lucide-react';

const StockMarketProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1611974765275-53c7b2d888fa?auto=format&fit=crop&w=2070&q=80"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Stock Market <br className="hidden lg:block" /> Trading & Investment
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Navigate the markets with confidence. Master technical analysis,
                    options strategies, value investing, and algorithmic trading to generate consistent wealth.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 20 Jun</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This program is designed for both beginners and aspiring professional traders.
            Learn to read charts, analyze financial statements, manage risk, and execute trades
            across Equity, Futures, and Options segments using professional tools.
        </p>
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'Stock Market',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Stock Market', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Trader Income', value: 'High Potential', icon: DollarSign },
            { label: 'Retail Participation', value: '+45% YoY', icon: Users },
            { label: 'Market Skill', value: 'Must Have', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">Tools & Platforms</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'TradingView', 'Zerodha Kite', 'Upstox', 'Sensibull', 'Excel',
                'Python (Pandas)', 'Screeners', 'Tickertape', 'Moneycontrol', 'Opstra'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">What You Will Do</h2>
        <div className="space-y-6">
            {[
                { title: 'Technical Analysis Report', type: 'Mini Project', desc: 'Analyze 5 Bluechip stocks using price action, indicators, and volume analysis.', icon: LineChart },
                { title: 'Long-Term Portfolio', type: 'Major Project', desc: 'Construct a diversified portfolio based on fundamental analysis and sector allocation.', icon: PieChart },
                { title: 'Backtested Algo Strategy', type: 'Capstone Project', desc: 'Design and backtest an automated trading strategy for Nifty 50 options using historical data.', icon: Zap },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        "Basics of Stock Market (IPO, Secondary Market, Indices)",
        "Fundamental Analysis (Ratios, Balance Sheet, P&L)",
        "Technical Analysis (Candlesticks, Dow Theory, Trends)",
        "Chart Patterns & Price Action Trading",
        "Technical Indicators (RSI, MACD, Moving Averages)",
        "Futures & Options (Call/Put, Open Interest, PCR)",
        "Option Strategies (Hedging, Straddle, Strangle)",
        "Trading Psychology & Risk Management",
        "Intraday & Delivery Trading Setup",
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-1 space-y-6">
                ...
                <p className="text-gray-400 text-lg">
                    Validate your trading skills with a professional certificate from Global Interns.
                    Showcase your expertise to potential employers or trading firms.
                </p>
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Trader Pro" price="₹9,999" features={['Everything in Self Paced', 'Live Market Sessions', 'Trading Journal Template', 'Strategy Review', '1 Year Access', 'Community Access']} recommended />
            <PricingCard title="Elite" price="₹19,999" features={['1-on-1 Mentorship', 'Live Algo Setup', 'Private Discord Group', 'Lifetime Access', 'Prop Desk Opportunities']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Zerodha', 'Angel One', 'Motilal Oswal', 'HDFC Securities', 'Groww', 'Upstox'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Stock Market program and start your journey towards financial freedom today.
            </p>
...
export default StockMarketProgram;

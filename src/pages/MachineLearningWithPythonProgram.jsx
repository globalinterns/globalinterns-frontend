...
const MachineLearningWithPythonProgram = () => {
    return (
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?auto=format&fit=crop&w=2070&q=80"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Global Interns - Microsoft - IBM. Master the art of Machine Learning using Python.
                </p>
    ...
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
                ...
                'Scikit-learn', 'TensorFlow', 'Keras', 'Jupyter'
            ].map((tool, idx) => (
        ...
        <div className="space-y-6">
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Implement a linear regression model to predict housing prices using Python.</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 p-6 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all bg-white">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Develop a comprehensive image classification system using Convolutional Neural Networks (CNNs).</p>
                </div>
            </div>
        </div>
    </section>
...
const SyllabusSection = () => {
    const modules = [
        "Module 1: Introduction to Python for Machine Learning (2 hours)",
        "Module 2: Data Preprocessing and Visualization (2 hours)",
        "Module 3: Supervised Learning Algorithms (2 hours)",
        "Module 4: Unsupervised Learning Algorithms (2 hours)",
        "Module 5: Model Evaluation and Optimization (2 hours)",
        "Module 6: Introduction to Deep Learning (2 hours)",
        "Module 7: Neural Networks and Backpropagation (2 hours)",
        "Module 8: Natural Language Processing Basics (2 hours)",
        "Module 9: Deploying Machine Learning Models (2 hours)",
        "Module 10: Capstone Project and Future Trends (2 hours)"
    ];
...
const ApplyForm = () => {
    const [formData, setFormData] = useState({
        ...
        phone: '',
        college: '',
        programOfInterest: 'IBM Machine Learning with Python',
        reason: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'IBM Machine Learning with Python', reason: '' });
...
export default MachineLearningWithPythonProgram;

...
import {
    ...
    DollarSign, PieChart, TrendingUp, Briefcase, BarChart2,
    Award, Landmark, Users, Briefcase as BriefcaseIcon
} from 'lucide-react';
...
const HeroSection = () => (
    <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute inset-0">
            <img
                src="https://images.unsplash.com/photo-1591696205602-2f950c417cb9?auto=format&fit=crop&w=2070&q=80"
                alt="Finance"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Financial Analysis & <br className="hidden lg:block" /> Investment Management
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Master the language of business. Learn financial modeling, valuation,
                    portfolio management, and market analysis to make data-driven investment decisions.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 10 May</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This comprehensive program bridges the gap between academic theory and practical finance.
            Covering everything from financial statement analysis to derivative markets,
            you will learn to build complex financial models and pitch investment strategies.
        </p>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Finance', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹6-12 LPA', icon: BriefcaseIcon },
            { label: 'Market Growth', value: 'Steady Rise', icon: TrendingUp },
            { label: 'Top Recruiters', value: 'Global Banks', icon: Landmark },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'Excel (Advanced)', 'Power BI', 'Tableau', 'Bloomberg', 'Python',
                'G-Suite', 'QuickBooks', 'Xero', 'SAP FICO', 'R'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        <h2 className="text-2xl font-bold text-gray-900 mb-8">What You Will Deliver</h2>
        <div className="space-y-6">
            {[
                { title: 'Company Valuation Report', type: 'Mini Project', desc: 'Perform a DCF analysis to determine the fair value of a publicly traded company.', icon: BarChart2 },
                { title: 'Portfolio Optimization', type: 'Major Project', desc: 'Create an optimal investment portfolio using Modern Portfolio Theory to maximize returns for given risk.', icon: PieChart },
                { title: 'M&A Pitch Deck', type: 'Capstone Project', desc: 'Prepare a complete buy-side pitchbook for a hypothetical merger, including synergies and deal structure.', icon: DollarSign },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Corporate Valuation (DCF, Relative Valuation)",
        "Portfolio Management & Asset Allocation",
        "Derivatives (Options, Futures, Swaps)",
        "Risk Management Fundamentals",
        "Technical Analysis & Trading Basics"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹15,499" features={['1-on-1 Mentorship', 'Live Trading Session', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['JPMorgan', 'Goldman Sachs', 'Morgan Stanley', 'Citi', 'Deloitte', 'HDFC Bank'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Finance program and kickstart your career in investment banking and analysis.
            </p>

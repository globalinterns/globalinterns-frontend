...
import {
    ...
    Bot, Cpu, Settings, Crosshair, Zap, Navigation,
    Briefcase, Award, TrendingUp, Users, Radio
} from 'lucide-react';
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
            ...
            >
                ...
                <h1 className="text-4xl lg:text-6xl font-semibold tracking-tight leading-tight mb-6">
                    Robotics & <br className="hidden lg:block" /> Automation
                </h1>

                {/* Subheading */}
                <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl mb-10">
                    Build intelligence into machines. Master Robot Operating System (ROS),
                    Kinematics, Computer Vision, and AI to design autonomous robots that change the world.
                </p>
                ...
                <div className="flex flex-wrap gap-x-10 gap-y-4 mb-12 text-sm text-white/70">
                    <div className="flex items-center gap-3">
                        ...
                        <span>Next batch starts 1 Apr</span>
                    </div>
...
const OverviewSection = () => (
    <section>
        ...
        <p className="text-gray-600 leading-relaxed mb-8 text-lg">
            This specialized program combines mechanical engineering, electronics, and computer science.
            You will learn to model robot dynamics, programme autonomous navigation, and integrate
            vision systems using OpenCV and ROS2, preparing you for Industry 4.0.
        </p>
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.result === 'success') {
                setStatus('success');
                setFormData({ fullName: '', email: '', phone: '', college: '', programOfInterest: 'Robotics', reason: '' });
...
const StatsSection = () => (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: 'Avg. Starting Salary', value: '₹6-14 LPA', icon: Briefcase },
            { label: 'Industrial Robot Sales', value: '+31% YoY', icon: Bot },
            { label: 'Future Jobs', value: 'Automation Era', icon: TrendingUp },
        ].map((stat, idx) => (
...
const ToolsSection = () => (
    <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
                'ROS / ROS2', 'Python', 'C++', 'OpenCV', 'Gazebo',
                'MATLAB', 'Arduino', 'Raspberry Pi', 'LiDAR', 'SLAM'
            ].map((tool, idx) => (
...
const ProjectsSection = () => (
    <section>
        ...
        <div className="space-y-6">
            {[
                { title: 'Line Following Robot', type: 'Mini Project', desc: 'Design a PID-controlled robot that follows a complex path with high precision.', icon: Navigation },
                { title: 'Robotic Arm Manipulation', type: 'Major Project', desc: 'Program a 6-DOF robotic arm to perform Pick & Place operations using inverse kinematics.', icon: Zap },
                { title: 'Autonomous Mobile Robot', type: 'Capstone Project', desc: 'Build a SLAM-enabled robot capable of mapping an unknown environment and navigating autonomously.', icon: Crosshair },
            ].map((project, idx) => (
...
const SyllabusSection = () => {
    const modules = [
        ...
        "Simulation with Gazebo & Rviz",
        "Computer Vision with OpenCV",
        "Path Planning & Navigation (A*, Dijkstra)",
        "SLAM (Simultaneous Localization and Mapping)",
        "Building a Real Autonomous Robot"
    ];
...
const PricingSection = () => (
    <section>
        ...
        <div className="grid md:grid-cols-3 gap-6">
            ...
            <PricingCard title="Professional" price="₹19,999" features={['1-on-1 Mentorship', 'Hardware Kit Included', 'Unlimited Mock Interviews', 'Lifetime Access', 'Premium Projects']} />
        </div>
    </section>
);
...
const AlumniSection = () => (
    <section className="text-center pt-8 border-t border-gray-100">
        ...
        <div className="flex flex-wrap justify-center gap-8 lg:gap-12 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            {['Boston Dynamics', 'ABB', 'Fanuc', 'Kuka', 'Amazon Robotics', 'SpaceX'].map((company, idx) => (
    ...
    <section className="bg-gray-50 border-t border-gray-200 py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Ready to Build Intelligent Machines?
            </h2>
            <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
                Join our Robotics program and gain the skills to engineering the automated future.
            </p>
